 /* -------------------------
       ...
       ------------------------- */
        ...
        function sendMessageByOtherPeople(cnt){
             if(cnt == 1){
                setTimeout(() => {
                    sendMessageToBoxGDTG('Người B', 'Oke a,  a tạo đi', '/img/sena.png');
                }, 5000); // 2000ms = 2s
                setTimeout(() => {
                ...
                setTimeout(() => {
                    sendMessageToBoxGDTG('Người B', 'Em đã gửi toàn bộ source code web cho bên kia rồi anh nhé', '/img/mixi.png');
                }, 5000); // 2000ms = 2s
            }
            else if(cnt == 3){
                setTimeout(() => {
                    sendMessageToBoxGDTG('Người B', 'Em đã nhận được toàn bộ source code của a DoMini rồi ạ. Em rất ưng mắt và thích dịch vụ này ạ', '/img/sena.png');
                }, 5000); // 2000ms = 2s
                setTimeout(() => {
                    sendMessageToBoxGDTG('Người B', 'Nhớ vote cho a 5 sao nhé em yêu', '/img/mixi.png');
                }, 8000); // 2000ms = 2s
            }
            else if(cnt == 4){
                setTimeout(() => {
                    sendMessageToBoxGDTG('Người B', 'Em tặng a số tiền đấy đó hihi', '/img/mixi.png');
                }, 5000); // 2000ms = 2s
                setTimeout(() => {
        ...
        sendMessageToBoxGDTG('Người A', 'Alo lộn đồ', '/img/sena.png');
        sendMessageToBoxGDTG('Người B', 'À nhầm a DoMini, giao dịch trung gian với em', '/img/sena.png');
        ...
        escrowForm.addEventListener('submit', e => {
            ...
            escrowForm.reset();
            setTimeout(() => {
                sendMessageToBoxGDTG('Người B', 'Đã thanh toán admin', '/img/sena.png');
            }, 5000); // 2000ms = 2s
        });
